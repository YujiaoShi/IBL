...
def compute_loss(dist_array, utms_x, UTMthres):
    '''
    :param dist_array:
...
def train(start_epoch=0):
    ...
    if 'threebranch' in network_type:
        ...
        loss_global = compute_loss(distance_global, utms_x, input_data.posDistSqThr)
        loss_local1 = compute_loss(distance_local1, utms_x, input_data.posDistSqThr)
        loss_local2 = compute_loss(distance_local2, utms_x, input_data.posDistSqThr)
        ...
        loss = compute_loss(distance, utms_x, input_data.posDistSqThr)
    ...
    with tf.Session(config=config) as sess:
        ...
        if start_epoch == 0:
            ...
            load_model_path = '../../2020cvpr/Model/Initialize/initial_model.ckpt'
            if len(var_dict1) > 0:
        ...
        for epoch in range(start_epoch, number_of_epoch):
            ...
            while True:
                ...
                feed_dict = {sat: batch_sat, grd: batch_grd, g2a: batch_g2a, a2g: batch_a2g, sat_polar: batch_sat_polar,
                             learning_rate: learning_rate_val, keep_prob: keep_prob_val, utms_x: batch_dis_utm}
                if iter % 20 == 0:
